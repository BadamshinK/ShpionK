...
if __name__ == "__main__":
    #graf1_1 = input("Сколько цветов: ")
    #graf1(int(graf1_1))
    #graf2_1 = input("Сколько цветов стало: ")
    #graf2(int(graf2_1))
    #graf3_1 = input("Сколько байт занимает изображение: ")
    #graf3(int(graf3_1))    
    graf4_1 = input("Сколько байт занимает изображение: ")
    graf4_2 = input("Сколько цветов в изображении: ")    
